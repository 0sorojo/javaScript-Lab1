...
if (Lawrence.detroitGC) {
  console.log(
    `My name is ${Lawrence.name} and I am a student at Grand Circus in Detroit, Michigan. I am currently ${Lawrence.age} years old and my birthday is ${Lawrence.birthday}`
  );
} else {
  console.log(
    `My name is ${Lawrence.name} and I am a student at Grand Circus in Grand Rapids, Michigan. I am currently ${Lawrence.age} years old and my birthday is ${Lawrence.birthday}`
  );
}
...
if (hours > 40) {
  ...
  console.log(
    `Wow! your worked ${hours} hours that means you get a bonus. At ${wage}$ an hour it looks like you will receive ${totalPaycheck}`
  );
} else {
  totalPaycheck = hours * wage;
  console.log(
    `Since you are lazy and only worked ${hours} hours, you will get a regular paycheck in the amount of ${totalPaycheck}`
  );
}
